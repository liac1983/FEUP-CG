...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.prism = new MyPrism(this, 6, 4); // Exemplo: Prisma com 6 lados e 4 andares
        ...
        this.ambientIntensity = 0.3; // Valor inicial
    ...
    initMaterials() {
        ...
        // Wood Material (Semelhante a Madeira)
        this.woodMaterial = new CGFappearance(this);
        this.woodMaterial.setAmbient(0.5, 0.3, 0.1, 1.0); // Marrom quente
        this.woodMaterial.setDiffuse(0.6, 0.4, 0.2, 1.0); // Cor principal da madeira
        this.woodMaterial.setSpecular(0.1, 0.1, 0.1, 1.0); // Baixa especularidade
        this.woodMaterial.setShininess(5.0); // Pouco brilho
