...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.texture = new CGFtexture(this, "textures/waterTex.jpg"); // Exercise 2.2 
		this.appearance.setTexture(this.texture);
		this.appearance.setTextureWrap('REPEAT', 'REPEAT');

		this.texture2 = new CGFtexture(this, "textures/waterMap.jpg"); // Exercise 2.2
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/bule.vert", "shaders/bule.frag"), // Added to complete exercise 1.1
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/gray.frag"), // Complete exercise 1.3
			new CGFshader(this.gl, "shaders/water.vert", "shaders/water.frag") // Added to complete 2.1
		];
		...
		this.shadersList = {
			...
			'Sepia': 7,
			'Convolution': 8,
			'Bule': 9, // Added to complete exercise 1.1
			'Gray': 10, // Complete exercise 1.3
			'Water': 11 // Added to complete exercise 2.1
		};
